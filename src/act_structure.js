...
// ---------------------------------------------------------------------
// v0.4.1.3 정리: label은 짧고, value는 ACT 명/설명
//   ACT 1: label "중국 72시간 목표", value "Xh 남음"
//   ACT 2: label "현재 국면", value "동맹 개입 전환기 · 봉쇄와 정치 압박"
//   ACT 3: label "현재 국면", value "동맹 개입 후 장기전 · 협상 우위 경쟁"
// =====================================================================
export function actHudLabel(state, campaign, chinaHoursRemainingFn) {
  ...
  if (act.id === "ACT_2") {
    return { label: "현재 국면", value: `${act.name} · ${act.description}`, tone: "amber" };
  }
  // ACT_3
  return { label: "현재 국면", value: `${act.name} · ${act.description}`, tone: "info" };
}
